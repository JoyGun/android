...
public class IDCardOCR extends AppCompatActivity {
    ...
    public static  IDCardOCR instance = null;
    @Override
...
//    String invokerPkg = getAppPkg(Binder.getCallingPid());
    ...
    public void initModel() {
        try{
            pointDetector = PointDetector.create(IDCardOCR.this,null,null,1);
            chineseCharacterRecognize = ChineseCharacterRecognize.create(IDCardOCR.this,null,null,1);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
